...
[results, fval, exitflag, output] = fminsearch('uv1to2itc',start1,options,initial,DA);
...
%NEXTLINEVARIABLE (Marker for section that is variable between different fitting programs)   
[ss, HG, HG2, qHG, HGG, ndhCA, SyC, RR]=uv1to2itc(para,initial,DA);
...
FitConcAndSpectra=struct('Host_Guest_Q_data',[HGG],'calculated_molar_heat',ndhCA,'host_guest_1t1_conc',HG,'heat_per_injection',qHG,'residuals',RR,'SyC',SyC,'host_guest_1t2_conc',HG2);
